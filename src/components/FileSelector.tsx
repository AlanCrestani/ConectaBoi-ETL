...
const FileSelector = ({
  ...
  console.log("[DEBUG] Configurações salvas detectadas:", savedConfigs);
    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-muted-foreground">
          Escolha qual arquivo você deseja configurar para importação
        </p>
      </div>
      ...
      {savedConfigs.length > 0 ? (
          ...
          <Card className="mt-6 border-dashed border-2 border-primary/20 bg-primary/5">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Você tem {savedConfigs.length} configuração(ões) salva(s). Pule
                direto para a tela de configurações.
              </p>
              {onGoToConfigs && (
        ...
        <div className="text-center text-xs text-muted-foreground mt-8">
          Nenhuma configuração salva detectada no localStorage.
          <br />
